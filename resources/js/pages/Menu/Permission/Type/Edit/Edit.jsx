...
const Edit = () => {
    const { CSRF_TOKEN, permissionType } = usePage().props;
    ...
    return (
        <main className="grid grid-cols-12 w-full gap-6 py-6">
            <Breadcrumbs className="col-span-12">
                ...
                <BreadcrumbItem href="/menus/permissions/types">Permission Type</BreadcrumbItem>
            ...
            <Card className="col-span-12 shadow-xl">
                <CardHeader className="w-full pt-6 px-6 pb-3 flex gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-small text-default-500">
                            Edit a permission type
                        </p>
                    </div>
                </CardHeader>
                <CardBody
                    as={"form"}
                    action={`/menus/permissions/types/${permissionType?.id}`}
                    method="POST"
                ...
                >
                    ...
                    <Input
                        ...
                        label="Name :"
                        name="name"
                        defaultValue={permissionType?.name}
                        variant="flat"
                    ...
                    <Button
                        color="primary"
                        type="submit"
                        className="col-span-12 md:col-span-6 md:row-start-2 w-full"
                    >
                        Edit
                    </Button>
                </CardBody>
