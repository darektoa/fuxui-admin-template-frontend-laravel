...
function useEventHandler() {
    ...
    return {
        btnDeleteOnClick: useCallback((item) => {
            tableAction.setShow({ deleteConfirmModal: item });
        }, []),
        ...
        deleteConfirmOnClose: useCallback(() => {
            tableAction.setShow({ deleteConfirmModal: null });
        }, []),
