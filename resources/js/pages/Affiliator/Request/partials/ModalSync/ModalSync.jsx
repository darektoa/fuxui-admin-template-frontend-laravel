    ...
    return (
        ...
        >
            <header className="sticky top-0 flex items-center justify-center bg-white px-6 pt-2 lg:p-6">
                <h2 className="text-center text-xl font-bold">Synchronize Account & Vouchers</h2>
                <Button
            ...
            <section className="flex h-full w-full flex-col p-6">
                ...
                <p className="mb-6 text-center text-base">
                    This will take a some time around 1 - 3 minutes. Do not close this browser tab while it is
                    still loading...
                </p>
                <form
